# Variation #3 of creating fake data
# Spectra are created as linear combinations of Dictionary entries
# Peaks of varying degrees are added to the spectra created in variation #2
    # Group 1 with little noise and few peaks of 0.125-0.375 relative height of max peak
    # Group 2 with medium noise and medium peaks of 0.375-0.750 relative height of max peak
    # Group 3 with lot of noise and many peaks of 0.75-1.25 relative height of max peak
...
def main():
    ...
    for i in range(1,6):
        ...
        # Add noise to the spectrum with SNR = 100
        Y_noisy = add_noise(Y, 100)
    ...
    for i in range(6,11):
        ...
        # Add noise to the spectrum with SNR = 50
        Y_noisy = add_noise(Y, 50)
    ...
    for i in range(11,16):
        ...
        # Add noise to the spectrum with SNR = 30
        Y_noisy = add_noise(Y, 30)
