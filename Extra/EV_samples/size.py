...
# Functino that checks the size of row vectors in .txt files (experimental EVs)
        ...
        if file_name.endswith('.txt'):
            ...
            try:
                with open(file_path, 'r') as file:
                    ...
                    if first_line:
                        # Split the line into elements using a comma as the delimiter
...
# Row vector of dimension: (1, 32768)