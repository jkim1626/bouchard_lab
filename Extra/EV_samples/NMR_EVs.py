...
FIGURES_PATH = os.path.join(DESKTOP_PATH, "EV_samples_2")
...
def alternating_solver(
    ...
    for iteration in range(1, max_iter+1):
        ...
        if sparse_beta:
            ...
            beta_new, _ = nnls(X, R, rcond=None)
...
def test(Xint, num_points, test_folder, test_file):        
    ...
    beta_lp, Z_lp = alternating_solver(
        ...
        sparse_beta=True, max_iter=50, tol=1e-6)
...
def main():    
    ...
    # Chemical shift axis (32768 points from 10 ppm to -2 ppm)
